...
def p_tipo(t) :
    ...
    if t[1].lower() == 'intq':
        t[0] = TIPO.ENTERO
    elif t[1].lower() == 'floatq':
        t[0] = TIPO.DECIMAL
    elif t[1].lower() == 'cadenaq':
        t[0] = TIPO.CADENA
    elif t[1].lower() == 'boolq':
        t[0] = TIPO.BOOLEANO
...
direcc = os.path.join(dirname, 'resultado.dot')
arch = open(direcc, "w+")
arch.write(grafo)
arch.close()
os.system('resultado -T pdf -o ast.pdf ast.dot')
